...
exports.default = function (config, assets, store, headers, component) {
  ...
  if (root) {
    var _ret = (function () {
      ...
      var _StyleSheetServer$ren = _aphrodite.StyleSheetServer.renderStatic(function () {
        return _server2.default.renderToString(_react2.default.createElement(Html, { assets: assets, store: store, component: component, headers: headers }));
      });
  ...
  var html = _StyleSheetServer$ren2.html;
